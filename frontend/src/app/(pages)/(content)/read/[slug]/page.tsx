...
import { findContentBySlug } from '@/app/(pages)/catalog/contentData'
...
export default function ReadDetailPage({ params }: Props) {
            ...
            <div className="container mx-auto px-6 py-8">
              ...
              <span className="bg-yellow-400 text-gray-900 text-lg font-bold px-3 py-1 rounded">
                ...
                {item.languageLevel}
                        ...
                        <button className="bg-slate-700 hover:bg-slate-800 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
                            Start Reading
                        </button>
                    </div>
                </div>

...
async def create_difficulty_level(
    difficulty_data: DifficultyLevelCreate, db: AsyncSession = Depends(get_async_session)
) -> DifficultyLevelRead:
...
async def update_difficulty_level(
    difficulty_id: int, difficulty_data: DifficultyLevelUpdate, db: AsyncSession = Depends(get_async_session)
) -> DifficultyLevelRead:

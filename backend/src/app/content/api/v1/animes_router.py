...
from app.content.schemas.content import AnimeRead, AnimeUpdate
from app.content.schemas.forms import AnimeFormData
...
async def create_anime(
    form_data: AnimeFormData = Depends(),
    ...
    try:
        ...
        anime_data = form_data.to_schema(banner_url=banner_url)
